            ...
            <div>
                <ul class="nav navbar-nav navbar-left">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="/admin/xhgk/gywx">关于无协</a></li>
                            <li class="divider"></li>
                            <li><a href="/admin/xhgk/xrls">现任理事</a></li>
                            <li class="divider"></li>
                            <li><a href="/admin/xhgk/bmjs">部门介绍</a></li>
                            <li class="divider"></li>
                            <li><a href="/admin/xhgk/jsxz">技术小组</a></li>
                        </ul>
                    </li>
                </ul>
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="/admin/sybj/lbt">轮播图</a></li>
                            <li class="divider"></li>
                            <li><a href="/admin/sybj/sydt">首页协会动态</a></li>
                        </ul>
                    </li>
                </ul>
                <ul class="nav navbar-nav">
